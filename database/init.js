...
const queries = [
  ...
  },
  {
    run: `CREATE TABLE plan (
            ...
            recurring_enabled TINYINT(1) DEFAULT 1,
  ...
  {
    run: "ALTER TABLE `plan` ADD COLUMN `recurring_enabled` TINYINT(1) DEFAULT 1 AFTER `yearly_price`;",
  ...
  },
  {
    ...
    check: "SHOW TABLES LIKE 'subscriptions';",
  },
  {
  ...
  },
  {
    run: `CREATE TABLE ai_providers (
            ...
            txt2img_auth_header_key        TEXT DEFAULT 'Authorization',
            ...
            txt2img_job_id_path            TEXT DEFAULT 'data.taskId',
            txt2img_status_endpoint        TEXT DEFAULT NULL,
            txt2img_status_method          VARCHAR(10) DEFAULT 'GET',
            txt2img_state_path             TEXT DEFAULT 'data.state',
            ...
            img2img_auth_header_key        TEXT DEFAULT 'Authorization',
            ...
            reel_auth_header_key           TEXT DEFAULT 'Authorization',
            ...
            showcase_auth_header_key       TEXT DEFAULT 'Authorization',
  ...
  {
    run: `ALTER TABLE ai_providers ADD COLUMN talking_auth_header_key TEXT DEFAULT 'Authorization';`,
  ...
  {
    run: `ALTER TABLE ai_providers ADD COLUMN talking_job_id_path TEXT DEFAULT 'jobId';`,
  ...
  {
    run: `ALTER TABLE ai_providers ADD COLUMN talking_state_path TEXT DEFAULT 'status';`,
  ...
  {
    run: `ALTER TABLE ai_providers ADD COLUMN talking_result_path TEXT DEFAULT 'resultUrl';`,
